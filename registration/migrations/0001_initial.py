    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('zipcode', models.CharField(default='06217',
                 max_length=5, null=True, verbose_name='zipcode')),
                ('city', models.CharField(default='Merseburg',
                ...
                ('created_at', models.DateTimeField(
                    default=registration.models.now)),
                ('media_autority', models.ForeignKey(default=registration.models.default_media_authority,
            ...
            options={
                'permissions': [('verified', 'Can access functionalities for verified users')],
            },
        ),
    ]
