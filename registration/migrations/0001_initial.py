        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(choices=[('none', 'Not Given'), ('m', 'Male'), (
                    'f', 'Female'), ('d', 'Diverse')], default='none', max_length=4)),
                ('phone_number', models.CharField(
                    blank=True, max_length=30, null=True)),
                ('mobile_number', models.CharField(
                    blank=True, max_length=30, null=True)),
                ('birthday', models.DateField(default=datetime.date(1990, 9, 1))),
                ('street', models.CharField(max_length=95, null=True)),
                ('house_number', models.CharField(max_length=20, null=True)),
                ('zipcode', models.CharField(
                    default='06217', max_length=5, null=True)),
                ('city', models.CharField(
                    default='Merseburg', max_length=35, null=True)),
                ('verified', models.BooleanField(default=False,
                 help_text='The profile data was verified by showing the ID to an employee.')),
